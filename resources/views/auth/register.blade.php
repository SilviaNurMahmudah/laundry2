  ...
  <div class="container-login100" style="background-image: url('page/images/bg-02.webp');">
    <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
      <form action="{{ route('register') }}" method="post" class="login100-form validate-form">
        ...
        <div class="wrap-input100 validate-input m-b-25" data-validate="Masukkan Nama">
          <input class="input100" id="nama" type="text" name="nama" placeholder="nama" required autocomplete="nama" autofocus>
          <span class="focus-input100"></span>
        </div>

        <div class="wrap-input100 validate-input m-b-20" data-validate="Masukan No.telp (Whatsapp)">
          <input class="input100" id="nohp" type="text" name="nohp" placeholder="No.telp (Whatsapp)" required autocomplete="nohp">
          <span class="focus-input100"></span>
        </div>
        ...
        <div class="wrap-input100 validate-input m-b-25" data-validate="konfirmasi password">
          <input class="input100" id="password-confirm" type="password" name="password_confirmation" placeholder="konfirmasi password" required autocomplete="new-password">
          <span class="focus-input100"></span>
        </div>
